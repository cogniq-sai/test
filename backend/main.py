...
# Import routers
from app.routers import auth_router, sites_router, plugin_router, scan_router, redirects_router, audits, analytics
...
app.include_router(audits.router)        # /api/audits/*
